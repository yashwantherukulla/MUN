  ...
  return (
    <AuthContextProvider>
      ...
      <div className="space-x-8 flex flex-row justify-center items-center">
            <Link href="/">
              <button className="text-white border-2 rounded-lg border-blue-500 p-3 text-lg mx-2">Explore MUN</button>
            </Link>
            <button onClick={handleSignIn} className="text-white border-2 rounded-lg border-blue-500 p-3 text-lg">
              Register Now
            </button>
          </div>
          </>
